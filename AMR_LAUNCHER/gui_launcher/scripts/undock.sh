...
ros2 action send_goal --feedback autodock custom_interface/action/Autodock "{is_dock: False}"

echo "Docking sequence finished."
# Script will exit now, triggering cleanup trap which kills the launch nodes.