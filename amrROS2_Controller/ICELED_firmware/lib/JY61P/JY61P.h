...
extern const uint8_t JY61P_save_conf_cmd[5];
extern const uint8_t JY61P_imu_cali_cmd[5];
extern const uint8_t JY61P_mag_cali_cmd[5];
extern const uint8_t JY61P_quit_cali_cmd[5];
