...
#ifdef USE_SMR_CONFIG
    #include "custom/smr_config.h"
#endif

#if !defined (USE_SMR_CONFIG) && !defined (USE_BEEBO_CONFIG) && !defined (USE_DEV_CONFIG) && !defined (USE_SQUARE_CONFIG) && !defined (USE_BEEBO_M_CONFIG)
