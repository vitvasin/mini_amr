...
# Copy of nav2_bringup/launch/bringup_launch.py using a custom navigation launch
# that excludes nav2_route (RouteServer).
...
def generate_launch_description():
    ...
    package_dir = get_package_share_directory('amr_nav2_slam_bringup')
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(package_dir, 'launch', 'navigation_no_route.launch.py')
                ),
                launch_arguments={
                    'namespace': namespace,
                    'use_sim_time': use_sim_time,
