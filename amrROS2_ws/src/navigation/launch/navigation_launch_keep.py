...
def generate_launch_description():
    ...
    lifecycle_nodes = [
        ...
        'waypoint_follower',
        # 'docking_server',
        # <-- add keepout lifecycle nodes here
    ...
    load_nodes = GroupAction(
        ...
        actions=[
           ...
           # <-- Insert keepout map_server node (non-composed) here
            Node(
    ...
    load_composable_nodes = GroupAction(
        ...
        actions=[
            ...
            LoadComposableNodes(
                ...
                condition=IfCondition(use_keepout_zones),   # <--- composed keepout nodes
    ...
    # <-- add keepout launch argument declarations to LD here
