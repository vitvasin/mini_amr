...
def main():
    ...
    query_img_path = script_dir+'/image_dataset/00001.png'

    global_extractor_name = 'netvlad'
    local_extractor_name = 'superpoint_aachen'
    local_matcher_name = 'superglue'

    image_gallery_path = script_dir+'/image_dataset'
    gallery_global_descriptor_path = script_dir+'/image_dataset/outputs/netvlad+superpoint_aachen+superglue/global-feats-netvlad.h5'
    gallery_local_descriptor_path = script_dir+'/image_dataset/outputs/netvlad+superpoint_aachen+superglue/feats-superpoint-n4096-r1024.h5'
    reference_sfm_path = script_dir+'/image_dataset/outputs/netvlad+superpoint_aachen+superglue/sfm_netvlad+superpoint_aachen+superglue'
